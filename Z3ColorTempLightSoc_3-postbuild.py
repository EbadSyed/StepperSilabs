...
def OTA():
    if not '"%PROJECT_DIR%\..\\..\\..\\protocol\\zigbee_5.10\\tool\\image-builder\\image-builder-windows.exe" --create "%TARGET_BPATH%.ota" --version 0x30 --manuf-id 0x1002 --image-type 0xa003 --tag-id 0x0000 --tag-file "%TARGET_BPATH%.gbl" --string "EBL Z3ColorTempLightSoc_3"':
        sys.exit(0)
    print " "
    ...
    IMAGE_BUILDER = '"%PROJECT_DIR%\..\\..\\..\\protocol\\zigbee_5.10\\tool\\image-builder\\image-builder-windows.exe" --create "%TARGET_BPATH%.ota" --version 0x30 --manuf-id 0x1002 --image-type 0xa003 --tag-id 0x0000 --tag-file "%TARGET_BPATH%.gbl" --string "EBL Z3ColorTempLightSoc_3"'.replace("\t", "\\t")
